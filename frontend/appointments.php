<?php
// Add session_start at the top of the file
session_start();
                                ...
                                <div class="table-responsive table-striped" id="appointmentsTable">
                                        ...
                                        <?php if (!empty($appointments)): ?>
                                            <?php foreach ($appointments as $index => $a): ?>
                                                <tr class="clickable-row"
                                                    onclick="window.location='appointmentdetails.php?id=<?= urlencode($a['id']) ?>'">
                                                    <td><?= $index + 1 ?></td>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-3">
                                        <div id="entry-info" class="text-gray-600 small">
                                            Showing 1 to <?= min(count($appointments), 10) ?>
                                            of <?= count($appointments) ?> entries
                                        </div>
                                        <nav>
